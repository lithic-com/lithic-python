...
Full Changelog: [...abc-v0.0.1](https://github.com/lithic-com/lithic-python/compare/...abc-v0.0.1)
...
* add `None` default value to nullable response properties ([#315](https://github.com/lithic-com/lithic-python/issues/315)) ([898a1df](https://github.com/lithic-com/lithic-python/commit/898a1df72cb355925c15c3c906d1e840b5a9bf9d))
...
* **api:** add `account_token` and `card_program_token` to `Card` ([#347](https://github.com/lithic-com/lithic-python/issues/347)) ([81f7b37](https://github.com/lithic-com/lithic-python/commit/81f7b376da316aad1df9a1b2e1c3eeab190981fd))
* **api:** add `get spend_limits` endpoints to `cards` and `accounts` ([#269](https://github.com/lithic-com/lithic-python/issues/269)) ([248c516](https://github.com/lithic-com/lithic-python/commit/248c516fb261e1125735abf41c2ba3dd4f882f67))
...
* **api:** add AUTH_STREAM_ACCESS to responder endpoints ([#205](https://github.com/lithic-com/lithic-python/issues/205)) ([515fe6c](https://github.com/lithic-com/lithic-python/commit/515fe6cd66ee565c03db4b2155f43303b5c412b0))
...
* **api:** add card renew endpoint ([#319](https://github.com/lithic-com/lithic-python/issues/319)) ([061beab](https://github.com/lithic-com/lithic-python/commit/061beab5e15bf5bb63d278222402b3825bc4bdff))
* **api:** add CardProgram and DigitalCardArt resources ([#213](https://github.com/lithic-com/lithic-python/issues/213)) ([4c40729](https://github.com/lithic-com/lithic-python/commit/4c407292711ed5c1933e580b0d9cd5167a60dacd))
...
* **api:** add search_by_pan endpoint ([#342](https://github.com/lithic-com/lithic-python/issues/342)) ([3d057bd](https://github.com/lithic-com/lithic-python/commit/3d057bde61e669131115d8fed83d6ecee5e8dfd9))
* **api:** add Simulate Return Payment endpoint ([#155](https://github.com/lithic-com/lithic-python/issues/155)) ([d8ac30b](https://github.com/lithic-com/lithic-python/commit/d8ac30b68c524ea2506bf11714816c1e6be4fdd5))
* **api:** add simulation endpoints, event types, fix transfer request AuthRule ([#164](https://github.com/lithic-com/lithic-python/issues/164)) ([c111e5c](https://github.com/lithic-com/lithic-python/commit/c111e5c3f3503496007b04032c007b8414ab30ff))
* **api:** add tokenizations.simulate and correct typo'd enum  ([#151](https://github.com/lithic-com/lithic-python/issues/151)) ([3ba7f4f](https://github.com/lithic-com/lithic-python/commit/3ba7f4f62af980bc316273f27718293306ee5311))
* **api:** add user defined id ([#144](https://github.com/lithic-com/lithic-python/issues/144)) ([941a8b9](https://github.com/lithic-com/lithic-python/commit/941a8b9dc8aafe4954fe46cbe76473686dee0ad0))
* **api:** add verification_attempts response property ([#223](https://github.com/lithic-com/lithic-python/issues/223)) ([d1e8064](https://github.com/lithic-com/lithic-python/commit/d1e806437c4033903fc3804b9b4e0ecf211ac804))
* **api:** add verification_failed_reason ([#203](https://github.com/lithic-com/lithic-python/issues/203)) ([eda8734](https://github.com/lithic-com/lithic-python/commit/eda8734a14ec393f8b92515264d564f251cba728))
...
* **api:** change account holder creation response, new settlement detail type ([#337](https://github.com/lithic-com/lithic-python/issues/337)) ([efaf6be](https://github.com/lithic-com/lithic-python/commit/efaf6bed746ac15027aaf341f45d254e2383fa35))
...
* **api:** remove /auth_stream enrollment endpoints ([#302](https://github.com/lithic-com/lithic-python/issues/302)) ([3dec2f6](https://github.com/lithic-com/lithic-python/commit/3dec2f6f8acb2c8b187cd4fdda7f2c015bb08748))
* **api:** remove `CLOSED` account enum and update docstrings ([#284](https://github.com/lithic-com/lithic-python/issues/284)) ([7508b46](https://github.com/lithic-com/lithic-python/commit/7508b461a33784932c7bcb07e18dcc56d9d1fe1a))
...
* **api:** rename `token` and `type` to `financial_account_token` and `financial_account_type` ([#299](https://github.com/lithic-com/lithic-python/issues/299)) ([f486f21](https://github.com/lithic-com/lithic-python/commit/f486f215cdfdba9a8c06f0261a1637154fb2b710))
...
* **api:** updates ([#179](https://github.com/lithic-com/lithic-python/issues/179)) ([e0b08f7](https://github.com/lithic-com/lithic-python/commit/e0b08f7abfcf0c4e179bac189c3c553e6575a7d7))
* **api:** updates ([#197](https://github.com/lithic-com/lithic-python/issues/197)) ([2047a06](https://github.com/lithic-com/lithic-python/commit/2047a065ffcdf6cbdf36b75e358ff3e9d0018fc2))
* **api:** updates ([#242](https://github.com/lithic-com/lithic-python/issues/242)) ([5b687c5](https://github.com/lithic-com/lithic-python/commit/5b687c5bc95bb09564a0fda6ff8447633ad607d3))
* **api:** updates ([#256](https://github.com/lithic-com/lithic-python/issues/256)) ([346dc00](https://github.com/lithic-com/lithic-python/commit/346dc00ca6da81fda831a83c39d1f5991cc4fd8c))
* **api:** updates ([#329](https://github.com/lithic-com/lithic-python/issues/329)) ([49ed9d5](https://github.com/lithic-com/lithic-python/commit/49ed9d5eabb74afb890b49884b4b2983427dc01d))
* **api:** updates ([#356](https://github.com/lithic-com/lithic-python/issues/356)) ([cc6fff6](https://github.com/lithic-com/lithic-python/commit/cc6fff6bb65a8a219ec4b5ae80d891e1607aca42))
...
* **client:** add forwards-compatible pydantic methods ([#181](https://github.com/lithic-com/lithic-python/issues/181)) ([42e6f5d](https://github.com/lithic-com/lithic-python/commit/42e6f5da9023189a0e35d751a0c30938f1275f2e))
* **client:** add logging setup ([#187](https://github.com/lithic-com/lithic-python/issues/187)) ([ee018a2](https://github.com/lithic-com/lithic-python/commit/ee018a25023f68882823d85d83d31ca10bf7aa15))
* **client:** add support for passing in a httpx client ([#183](https://github.com/lithic-com/lithic-python/issues/183)) ([2d2761e](https://github.com/lithic-com/lithic-python/commit/2d2761e70c7a1ce9be1af025199bb905528e027d))
* **client:** add support for streaming raw responses ([#323](https://github.com/lithic-com/lithic-python/issues/323)) ([814d931](https://github.com/lithic-com/lithic-python/commit/814d931cd0d8f9e70617ca7918348f28f921b3d2))
* **client:** adjust retry behavior to be exponential backoff ([#209](https://github.com/lithic-com/lithic-python/issues/209)) ([0872059](https://github.com/lithic-com/lithic-python/commit/0872059423bf0a5ad3eb1a195abaa39b21e69d6d))
* **client:** allow binary returns ([#224](https://github.com/lithic-com/lithic-python/issues/224)) ([e9ac9d1](https://github.com/lithic-com/lithic-python/commit/e9ac9d172ac36cec66309704ccb5d6ee8ee82ca8))
* **client:** enable follow redirects by default ([#338](https://github.com/lithic-com/lithic-python/issues/338)) ([484d5f4](https://github.com/lithic-com/lithic-python/commit/484d5f4ced32947c285ccc4eaf5696c17cb93292))
* **client:** handle retry-after header with a date format ([#176](https://github.com/lithic-com/lithic-python/issues/176)) ([5b8684e](https://github.com/lithic-com/lithic-python/commit/5b8684e1df7e23ca0234f712b34f4b42228bb2f4))
* **client:** improve file upload types ([#208](https://github.com/lithic-com/lithic-python/issues/208)) ([844d3ec](https://github.com/lithic-com/lithic-python/commit/844d3ec3f8c13827b277f8ef09f0e10f3b08fdd6))
* **client:** retry on 408 Request Timeout ([#160](https://github.com/lithic-com/lithic-python/issues/160)) ([63347b6](https://github.com/lithic-com/lithic-python/commit/63347b626db80789406456ea86da1704057ecf11))
* **client:** support accessing raw response objects ([#218](https://github.com/lithic-com/lithic-python/issues/218)) ([217f0e0](https://github.com/lithic-com/lithic-python/commit/217f0e00f603141a7f7dab7d707cf80da8aab98c))
* **client:** support parsing custom response types ([#343](https://github.com/lithic-com/lithic-python/issues/343)) ([eb80f99](https://github.com/lithic-com/lithic-python/commit/eb80f9926bb43f2c552e37ad6215cd03ad0d9965))
* **client:** support passing BaseModels to request params at runtime ([#225](https://github.com/lithic-com/lithic-python/issues/225)) ([c9637e4](https://github.com/lithic-com/lithic-python/commit/c9637e44198333509ead1f2b00723b860cd19c66))
* **client:** support passing chunk size for binary responses ([#241](https://github.com/lithic-com/lithic-python/issues/241)) ([6d0d4fc](https://github.com/lithic-com/lithic-python/commit/6d0d4fc433c0f2b6e7c8884d7a2cb1133b1debfb))
* **client:** support passing httpx.Timeout to method timeout argument ([#234](https://github.com/lithic-com/lithic-python/issues/234)) ([f503c9b](https://github.com/lithic-com/lithic-python/commit/f503c9b761a8edc0e07bec91a01f38c13538e752))
* **client:** support passing httpx.URL instances to base_url ([#199](https://github.com/lithic-com/lithic-python/issues/199)) ([e4dd962](https://github.com/lithic-com/lithic-python/commit/e4dd9628bcb85f96545e10c6c206e170e26a8ca4))
* **client:** support reading the base url from an env variable ([#255](https://github.com/lithic-com/lithic-python/issues/255)) ([e8e598f](https://github.com/lithic-com/lithic-python/commit/e8e598faa6409f9e21318eefda2f19286f889509))
* fixes tests where an array has to have unique enum values ([#147](https://github.com/lithic-com/lithic-python/issues/147)) ([30c6ef0](https://github.com/lithic-com/lithic-python/commit/30c6ef0b23c8789c2491eddf16a913f60de4bc25))
* **github:** include a devcontainer setup ([#222](https://github.com/lithic-com/lithic-python/issues/222)) ([7741c9a](https://github.com/lithic-com/lithic-python/commit/7741c9a67bd80149626dc152f7be20479d75a110))
* make webhook headers case insensitive ([#190](https://github.com/lithic-com/lithic-python/issues/190)) ([4616364](https://github.com/lithic-com/lithic-python/commit/46163647ce7948e8c3085f022fa3b8831db976de))
* **package:** add classifiers ([#221](https://github.com/lithic-com/lithic-python/issues/221)) ([d2143ba](https://github.com/lithic-com/lithic-python/commit/d2143ba5ef5d711dc929de093a09b88d74a21bdd))
* **package:** export a root error type ([#169](https://github.com/lithic-com/lithic-python/issues/169)) ([79731a6](https://github.com/lithic-com/lithic-python/commit/79731a6ba8d2f12f37d4c1895a33e1c45aeeaa11))
* remove idempotency headers ([#346](https://github.com/lithic-com/lithic-python/issues/346)) ([8ee9920](https://github.com/lithic-com/lithic-python/commit/8ee99202aefbf3cd358ce143c82ba1453cf314f0))
* **types:** remove unused types ([#145](https://github.com/lithic-com/lithic-python/issues/145)) ([ee9c828](https://github.com/lithic-com/lithic-python/commit/ee9c828eb7e5d251499a9b0ba9a9a6c80bd89a11))
...
* **api:** correct type for other fees details ([#238](https://github.com/lithic-com/lithic-python/issues/238)) ([d4fffa6](https://github.com/lithic-com/lithic-python/commit/d4fffa60b455232cb18ddf408f95bfe28556723e))
* avoid leaking memory when Client.with_options is used ([#293](https://github.com/lithic-com/lithic-python/issues/293)) ([c890259](https://github.com/lithic-com/lithic-python/commit/c89025930130a61dea1a22695f68588886a8c29c))
* **binaries:** don't synchronously block in astream_to_file ([#226](https://github.com/lithic-com/lithic-python/issues/226)) ([ab25914](https://github.com/lithic-com/lithic-python/commit/ab25914fad7ae0d61df2ed84d3e42b8a177f9914))
* **client:** accept io.IOBase instances in file params ([#194](https://github.com/lithic-com/lithic-python/issues/194)) ([b3925b9](https://github.com/lithic-com/lithic-python/commit/b3925b9ff5c7bfc24aa69a88e16dc2d271e0705f))
* **client:** attempt to parse unknown json content types ([#261](https://github.com/lithic-com/lithic-python/issues/261)) ([3661a7f](https://github.com/lithic-com/lithic-python/commit/3661a7f693263840565616e9efcc3ef79e8f4d03))
* **client:** correct base_url setter implementation ([#280](https://github.com/lithic-com/lithic-python/issues/280)) ([b00d990](https://github.com/lithic-com/lithic-python/commit/b00d990322b302cc294803d283a5f139f718a4bc))
* **client:** correctly handle arguments with env vars ([#188](https://github.com/lithic-com/lithic-python/issues/188)) ([a43fc51](https://github.com/lithic-com/lithic-python/commit/a43fc516a7415ee430c10e917ff002a6e132d9a8))
...
* **client:** correctly use custom http client auth ([#311](https://github.com/lithic-com/lithic-python/issues/311)) ([3d6b777](https://github.com/lithic-com/lithic-python/commit/3d6b7779d7a4a8f1e4e1e3ed845fab7ec9a06660))
* **client:** don't error by default for unexpected content types ([#166](https://github.com/lithic-com/lithic-python/issues/166)) ([2e0730f](https://github.com/lithic-com/lithic-python/commit/2e0730f0ab47f2e17e5ea8f5a378285466e42f90))
* **client:** ensure path params are non-empty ([#324](https://github.com/lithic-com/lithic-python/issues/324)) ([8a1649c](https://github.com/lithic-com/lithic-python/commit/8a1649c899802084e4bbf9a09da82a9960a82a5f))
* **client:** ensure retried requests are closed ([#274](https://github.com/lithic-com/lithic-python/issues/274)) ([36d7dca](https://github.com/lithic-com/lithic-python/commit/36d7dca5e271198499b3014a28dbce24b6938d41))
* **client:** properly configure model set fields ([#159](https://github.com/lithic-com/lithic-python/issues/159)) ([1e3fb92](https://github.com/lithic-com/lithic-python/commit/1e3fb922480caa8ce4df0439ecef191b49374b8b))
* **client:** properly handle optional file params ([#146](https://github.com/lithic-com/lithic-python/issues/146)) ([99e830a](https://github.com/lithic-com/lithic-python/commit/99e830a069079a952ed8dfaa3857c853c5b92c7d))
* **client:** retry if SSLWantReadError occurs in the async client ([#249](https://github.com/lithic-com/lithic-python/issues/249)) ([7380057](https://github.com/lithic-com/lithic-python/commit/73800576001bb6f319abdc53e33feb665cc94c84))
* **client:** serialise pydantic v1 default fields correctly in params ([#247](https://github.com/lithic-com/lithic-python/issues/247)) ([7c5a0a0](https://github.com/lithic-com/lithic-python/commit/7c5a0a07429d965c9fef010f4dad3d1d8308cc1c))
...
* **errors:** properly assign APIError.body ([#292](https://github.com/lithic-com/lithic-python/issues/292)) ([aa270c8](https://github.com/lithic-com/lithic-python/commit/aa270c8697f892e93f36c74acc00ee108ad828a5))
* **models:** mark unknown fields as set in pydantic v1 ([#246](https://github.com/lithic-com/lithic-python/issues/246)) ([d1d1504](https://github.com/lithic-com/lithic-python/commit/d1d15046db1bd47833530a3ccf844deb60190d5f))
* prevent crash when platform.architecture() is not allowed ([#351](https://github.com/lithic-com/lithic-python/issues/351)) ([9b03c73](https://github.com/lithic-com/lithic-python/commit/9b03c734b9df790459accc52b8a4b95f1746b9ed))
* prevent TypeError in Python 3.8 (ABC is not subscriptable) ([#233](https://github.com/lithic-com/lithic-python/issues/233)) ([87e688b](https://github.com/lithic-com/lithic-python/commit/87e688b4ed3085632ae2d634543c91184da70c65))
* **types:** loosen most List params types to Iterable ([#355](https://github.com/lithic-com/lithic-python/issues/355)) ([e5c522b](https://github.com/lithic-com/lithic-python/commit/e5c522b3c9bdd762e73ad1cd68b577c72db3f07c))


### Code Refactoring

* **api:** remove `post /webhooks/account_holders` endpoint ([#171](https://github.com/lithic-com/lithic-python/issues/171)) ([bce5062](https://github.com/lithic-com/lithic-python/commit/bce50620d4aefb695ac865b881b33eac6ad89bbc))
