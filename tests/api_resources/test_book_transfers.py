...
class TestBookTransfers:
    ...
    def test_method_retry(self, client: Lithic) -> None:
        book_transfer = client.book_transfers.retry(
    ...
    def test_raw_response_retry(self, client: Lithic) -> None:
        response = client.book_transfers.with_raw_response.retry(
            book_transfer_token="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            retry_token="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_retry(self, client: Lithic) -> None:
        with client.book_transfers.with_streaming_response.retry(
            book_transfer_token="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            retry_token="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_retry(self, client: Lithic) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `book_transfer_token` but received ''"):
            client.book_transfers.with_raw_response.retry(
                book_transfer_token="",
                retry_token="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            )
...
class TestAsyncBookTransfers:
    ...
    async def test_method_retry(self, async_client: AsyncLithic) -> None:
        book_transfer = await async_client.book_transfers.retry(
            book_transfer_token="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            retry_token="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(BookTransferResponse, book_transfer, path=["response"])
    ...
    async def test_raw_response_retry(self, async_client: AsyncLithic) -> None:
        response = await async_client.book_transfers.with_raw_response.retry(
            book_transfer_token="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            retry_token="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_retry(self, async_client: AsyncLithic) -> None:
        async with async_client.book_transfers.with_streaming_response.retry(
            book_transfer_token="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            retry_token="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_retry(self, async_client: AsyncLithic) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `book_transfer_token` but received ''"):
            await async_client.book_transfers.with_raw_response.retry(
                book_transfer_token="",
                retry_token="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            )
