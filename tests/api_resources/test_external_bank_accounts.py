...
class TestExternalBankAccounts:
    ...
    def test_raw_response_pause(self, client: Lithic) -> None:
        response = client.external_bank_accounts.with_raw_response.pause(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_pause(self, client: Lithic) -> None:
        with client.external_bank_accounts.with_streaming_response.pause(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_pause(self, client: Lithic) -> None:
        with pytest.raises(
            ...
            client.external_bank_accounts.with_raw_response.pause(
                "",
            )
...
class TestAsyncExternalBankAccounts:
    ...
    async def test_method_pause(self, async_client: AsyncLithic) -> None:
        external_bank_account = await async_client.external_bank_accounts.pause(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(ExternalBankAccount, external_bank_account, path=["response"])
    ...
    async def test_raw_response_pause(self, async_client: AsyncLithic) -> None:
        response = await async_client.external_bank_accounts.with_raw_response.pause(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_pause(self, async_client: AsyncLithic) -> None:
        async with async_client.external_bank_accounts.with_streaming_response.pause(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_pause(self, async_client: AsyncLithic) -> None:
        with pytest.raises(
            ...
            await async_client.external_bank_accounts.with_raw_response.pause(
                "",
            )
