...
class TestAsyncFinancialTransactions:
    ...
    async def test_streaming_response_retrieve(self, client: AsyncLithic) -> None:
        async with client.financial_accounts.financial_transactions.with_streaming_response.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            financial_account_token="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_retrieve(self, client: AsyncLithic) -> None:
        with pytest.raises(
            ...
            await client.financial_accounts.financial_transactions.with_raw_response.retrieve(
                "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
                financial_account_token="",
            )
    ...
    async def test_streaming_response_list(self, client: AsyncLithic) -> None:
        async with client.financial_accounts.financial_transactions.with_streaming_response.list(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_list(self, client: AsyncLithic) -> None:
        with pytest.raises(
            ...
            await client.financial_accounts.financial_transactions.with_raw_response.list(
                "",
            )
