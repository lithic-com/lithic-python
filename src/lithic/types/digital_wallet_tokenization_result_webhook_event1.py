...
__all__ = ["DigitalWalletTokenizationResultWebhookEvent", "TokenizationResultDetails"]
...
class DigitalWalletTokenizationResultWebhookEvent(BaseModel):
    account_token: str
    """Account token"""
    ...
    event_type: Literal["digital_wallet.tokenization_result"]
