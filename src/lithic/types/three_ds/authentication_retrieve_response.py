...
class AdditionalData(BaseModel):
    network_decision: Optional[Literal["LOW_RISK", "NOT_LOW_RISK"]]
    """
...
class Cardholder(BaseModel):
    ...
    billing_address: Optional[CardholderBillingAddress]
    ...
    shipping_address: Optional[CardholderShippingAddress]
    """Object containing data on the shipping address provided during the transaction."""


class MerchantRiskIndicator(BaseModel):
    delivery_email_address: Optional[str]
    """
    ...
    gift_card_count: Optional[float]
    """
    ...
    pre_order_available_date: Optional[datetime]
    """
    ...
    reorder_items: Optional[Literal["FIRST_TIME_ORDERED", "REORDERED"]]
...
class AuthenticationRetrieveResponse(BaseModel):
    ...
    decision_made_by: Optional[Literal["LITHIC_DEFAULT", "LITHIC_RULES", "CUSTOMER_ENDPOINT"]]
