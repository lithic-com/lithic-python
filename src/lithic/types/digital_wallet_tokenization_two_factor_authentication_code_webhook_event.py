...
__all__ = ["DigitalWalletTokenizationTwoFactorAuthenticationCodeWebhookEvent", "ActivationMethod"]
...
class DigitalWalletTokenizationTwoFactorAuthenticationCodeWebhookEvent(BaseModel):
    account_token: str
    ...
    event_type: Literal["digital_wallet.tokenization_two_factor_authentication_code"]
