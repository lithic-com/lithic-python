...
__all__ = ["DigitalWalletTokenizationTwoFactorAuthenticationCodeSentWebhookEvent", "ActivationMethod"]
...
class DigitalWalletTokenizationTwoFactorAuthenticationCodeSentWebhookEvent(BaseModel):
    account_token: str
    ...
    event_type: Literal["digital_wallet.tokenization_two_factor_authentication_code_sent"]
