...
__all__ = ["TokenizationTwoFactorAuthenticationCodeWebhookEvent", "ActivationMethod"]
...
class TokenizationTwoFactorAuthenticationCodeWebhookEvent(BaseModel):
    account_token: str
    ...
    event_type: Literal["tokenization.two_factor_authentication_code"]
