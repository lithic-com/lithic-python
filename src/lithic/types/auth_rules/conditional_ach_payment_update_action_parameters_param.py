...
from .ach_payment_update_action_param import ACHPaymentUpdateActionParam

__all__ = ["ConditionalACHPaymentUpdateActionParametersParam", "Condition"]
...
class ConditionalACHPaymentUpdateActionParametersParam(TypedDict, total=False):
    action: Required[ACHPaymentUpdateActionParam]
