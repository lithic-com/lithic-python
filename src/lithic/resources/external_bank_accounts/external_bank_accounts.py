...
from .micro_deposits import MicroDeposits, AsyncMicroDeposits
...
class ExternalBankAccounts(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        verification_method: VerificationMethod,
        account_token: str | NotGiven = NOT_GIVEN,
        address: external_bank_account_create_params.ExternalBankAccountAddress | NotGiven = NOT_GIVEN,
        company_id: str | NotGiven = NOT_GIVEN,
        dob: Union[str, date] | NotGiven = NOT_GIVEN,
        doing_business_as: str | NotGiven = NOT_GIVEN,
    ...
    def update(
        ...
        external_bank_account_token: str,
        *,
        address: external_bank_account_update_params.ExternalBankAccountAddress | NotGiven = NOT_GIVEN,
        company_id: str | NotGiven = NOT_GIVEN,
        dob: Union[str, date] | NotGiven = NOT_GIVEN,
        doing_business_as: str | NotGiven = NOT_GIVEN,
        name: str | NotGiven = NOT_GIVEN,
    ...
    def list(
        ...
        *,
        ...
        owner_types: List[Literal["INDIVIDUAL", "BUSINESS"]] | NotGiven = NOT_GIVEN,
